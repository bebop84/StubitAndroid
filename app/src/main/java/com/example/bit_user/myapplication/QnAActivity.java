...
public class QnAActivity extends Activity {
    ...
    private class GCMTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                HttpRequest request = post("http://192.168.0.5:8088/bitin/api/class/classinfo-by-userid");
    ...
    private class DBTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                HttpRequest request = post("http://192.168.0.5:8088/bitin/api/qna/create-q");
                request.connectTimeout(2000).readTimeout(2000);
