...
public class MessageTeacher extends Activity {
    ...
    private class qnaTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                HttpRequest request = post("http://192.168.0.5:8088/bitin/api/qna/list-q");
    ...
    private class RemoveTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                HttpRequest request = post("http://192.168.0.5:8088/bitin/api/qna/delete-q");
                request.connectTimeout(2000).readTimeout(2000);
    ...
    private class phoneIdTask extends AsyncTask<String, Void, String> {
        protected String doInBackground(String... params) {
            try {
                HttpRequest request = post("http://192.168.0.5:8088/bitin/api/user/useridbyphoneid");
                request.connectTimeout(2000).readTimeout(2000);
